...
## Status (2026-09-12) — closed, nothing outstanding

**S-3 was answered on 2026-09-12 and this ticket has no open row left.** The
...
**Status (2026-09-11, after wave 2), as it stood before that:** everything else this
...
| Open | One line | State |
|---|---|---|
| S-3 | The monitoring listener is unauthenticated on `:9090` | **Answered 2026-09-12**: left unauthenticated, the two identifying labels dropped, no `NetworkPolicy` shipped (ADR 0014 D11) |
...
2. **Met for all eight rows.** **S-3** was the last, and it was a decision
   rather than work; it was answered on 2026-09-12, see the status block.
