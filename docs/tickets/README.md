...
| [018](018-listobjectsv2-document.md) | **Landed 2026-09-10**, two items left | A real `ListBucketResult` document, the dropped listing parameters, and plaintext sizes computed from the stored size — all shipped ([ADR 0010](../adr/0010-sizes-and-listings-describe-the-plaintext.md)). What remains is the listing benchmark and the Velero run | P-4 |
