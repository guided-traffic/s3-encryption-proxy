...
// TestChunkedUploadDecoding has been moved to test/integration/chunked_encoding_test.go
// because it requires MinIO infrastructure and proxy setup, making it an integration test
