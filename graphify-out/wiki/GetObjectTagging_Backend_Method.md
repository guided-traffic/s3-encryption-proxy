# GetObjectTagging Backend Method
...
- **github.com/aws/aws-sdk-go-v2/service/s3.GetObjectTaggingInput** (4 connections)
- **github.com/aws/aws-sdk-go-v2/service/s3.GetObjectTaggingOutput** (4 connections)
- **.GetObjectTagging()** (4 connections) — `internal/proxy/handlers/multipart/multipart_test.go`
- **.GetObjectTagging()** (4 connections) — `internal/proxy/handlers/object/test_helpers_test.go`
