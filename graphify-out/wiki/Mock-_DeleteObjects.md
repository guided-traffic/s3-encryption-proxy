...
- **github.com/aws/aws-sdk-go-v2/service/s3.DeleteObjectsInput** (4 connections)
- **github.com/aws/aws-sdk-go-v2/service/s3.DeleteObjectsOutput** (4 connections)
- **.DeleteObjects()** (4 connections) — `internal/proxy/handlers/multipart/multipart_test.go`
- **.DeleteObjects()** (4 connections) — `internal/proxy/handlers/object/test_helpers_test.go`
- **.DeleteObjects()** (4 connections) — `internal/proxy/handlers/root/test_helpers_test.go`
