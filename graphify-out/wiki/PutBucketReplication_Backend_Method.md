# PutBucketReplication Backend Method
...
- **github.com/aws/aws-sdk-go-v2/service/s3.PutBucketReplicationInput** (4 connections)
- **github.com/aws/aws-sdk-go-v2/service/s3.PutBucketReplicationOutput** (4 connections)
- **.PutBucketReplication()** (4 connections) — `internal/proxy/handlers/multipart/multipart_test.go`
- **.PutBucketReplication()** (4 connections) — `internal/proxy/handlers/object/test_helpers_test.go`
