...
- **start-demo.sh** (19 connections) — `start-demo.sh`
- **main()** (18 connections) — `start-demo.sh`
- **performance.sh** (16 connections) — `performance.sh`
- **log_info()** (12 connections) — `start-demo.sh`
...
- **ensure_license_token()** (4 connections) — `start-demo.sh`
- **log_error()** (4 connections) — `start-demo.sh`
- **log_warning()** (4 connections) — `start-demo.sh`
