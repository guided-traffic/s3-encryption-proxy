...
- **github.com/aws/aws-sdk-go-v2/service/s3.PutBucketLoggingOutput** (4 connections)
- **.PutBucketLogging()** (4 connections) — `internal/proxy/handlers/multipart/multipart_test.go`
- **.PutBucketLogging()** (4 connections) — `internal/proxy/handlers/object/test_helpers_test.go`
- **.PutBucketLogging()** (4 connections) — `internal/proxy/handlers/root/test_helpers_test.go`
