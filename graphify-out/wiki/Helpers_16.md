...
- **github.com/aws/aws-sdk-go-v2/service/s3.GetBucketWebsiteOutput** (5 connections)
- **.GetBucketWebsite()** (4 connections) — `internal/proxy/handlers/bucket/test_helpers_test.go`
- **github.com/aws/aws-sdk-go-v2/service/s3.GetBucketWebsiteInput** (4 connections)
- **.GetBucketWebsite()** (4 connections) — `internal/proxy/handlers/multipart/multipart_test.go`
- **.GetBucketWebsite()** (4 connections) — `internal/proxy/handlers/object/test_helpers_test.go`
- **.GetBucketWebsite()** (4 connections) — `internal/proxy/handlers/root/test_helpers_test.go`
...
- [Bucket XML Document Types](Bucket_XML_Document_Types.md) (1 shared connections)
