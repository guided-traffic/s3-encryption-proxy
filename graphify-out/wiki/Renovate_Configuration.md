...
- **branchConcurrentLimit** (1 connections) — `renovate.json`
- **commitMessagePrefix** (1 connections) — `renovate.json`
- **configMigration** (1 connections) — `renovate.json`
- **customManagers** (1 connections) — `renovate.json`
- **enabled** (1 connections) — `renovate.json`
- **forkProcessing** (1 connections) — `renovate.json`
- **gitAuthor** (1 connections) — `renovate.json`
- **enabled** (1 connections) — `renovate.json`
- **enabled** (1 connections) — `renovate.json`
