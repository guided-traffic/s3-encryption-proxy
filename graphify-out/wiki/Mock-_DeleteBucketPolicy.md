...
- **.DeleteBucketPolicy()** (4 connections) — `internal/proxy/handlers/multipart/multipart_test.go`
- **.DeleteBucketPolicy()** (4 connections) — `internal/proxy/handlers/object/test_helpers_test.go`
- **.DeleteBucketPolicy()** (4 connections) — `internal/proxy/handlers/root/test_helpers_test.go`
