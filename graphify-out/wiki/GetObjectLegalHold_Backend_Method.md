# GetObjectLegalHold Backend Method
...
- **.GetObjectLegalHold()** (4 connections) — `internal/proxy/handlers/multipart/multipart_test.go`
- **.GetObjectLegalHold()** (4 connections) — `internal/proxy/handlers/object/test_helpers_test.go`
