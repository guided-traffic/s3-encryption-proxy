# PutBucketWebsite Backend Method
...
- **github.com/aws/aws-sdk-go-v2/service/s3.PutBucketWebsiteInput** (4 connections)
- **github.com/aws/aws-sdk-go-v2/service/s3.PutBucketWebsiteOutput** (4 connections)
- **.PutBucketWebsite()** (4 connections) — `internal/proxy/handlers/multipart/multipart_test.go`
- **.PutBucketWebsite()** (4 connections) — `internal/proxy/handlers/object/test_helpers_test.go`
