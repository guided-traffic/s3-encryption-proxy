# PutBucketAccelerate Backend Method
...
- **github.com/aws/aws-sdk-go-v2/service/s3.PutBucketAccelerateConfigurationInput** (4 connections)
- **github.com/aws/aws-sdk-go-v2/service/s3.PutBucketAccelerateConfigurationOutput** (4 connections)
- **.PutBucketAccelerateConfiguration()** (4 connections) — `internal/proxy/handlers/multipart/multipart_test.go`
- **.PutBucketAccelerateConfiguration()** (4 connections) — `internal/proxy/handlers/object/test_helpers_test.go`
