...
vuln:
	...
	@which govulncheck > /dev/null || (echo "Installing govulncheck..." && GOTOOLCHAIN=go1.25.6 go install golang.org/x/vuln/cmd/govulncheck@latest)
	GOTOOLCHAIN=go1.25.6 GOFLAGS="-buildvcs=false" govulncheck ./...
