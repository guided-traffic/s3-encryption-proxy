...
vuln:
	...
	@which govulncheck > /dev/null || (echo "Installing govulncheck..." && GOTOOLCHAIN=go1.25.7 go install golang.org/x/vuln/cmd/govulncheck@latest)
	GOTOOLCHAIN=go1.25.7 GOFLAGS="-buildvcs=false" govulncheck ./...
